...
export function ContactForm({ ownerName, phone, services }: ContactFormProps) {
  ...
  const inputClass =
    "focus-ring mt-1 w-full rounded-md border border-border px-3 py-3";
    ...
    <form className="card p-6" onSubmit={handleSubmit} data-testid="contact-form">
      ...
      <div className="mt-4">
        ...
        <div
          ...
          className={`focus-ring mt-1 cursor-pointer rounded-md border border-dashed px-4 py-5 text-center transition-colors ${
            dragOver

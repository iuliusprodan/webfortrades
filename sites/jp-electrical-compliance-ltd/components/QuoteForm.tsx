    ...
    >
      {submitted ? (
        <div className="form-success" role="status">
          Thanks, your job details are ready to send to JP Electrical.
        </div>
      ) : null}
      ...
      <div className={`form-row${invalid.jobtype ? " has-error" : ""}`}>
        ...
        <select id="jobtype" name="jobtype" required defaultValue=""
          ...
          <option value="eicr">EICR / testing and inspection</option>
          <option value="consumer-unit">Consumer unit upgrade</option>
          <option value="ev-charger">EV charger</option>
          <option value="rewire">Rewire / new circuits</option>
          <option value="fault">Fault-finding / repair</option>
      ...
      <div className={`form-row${invalid.details ? " has-error" : ""}`}>
        ...
        <textarea id="details" name="details" rows={4} required
          placeholder="The property, what you need, and roughly when."

...
const description = `${brief.trade} in ${brief.service_area[0]}. Roof repairs, re-roofs, storm damage. Call ${brief.phone}.`;
...
export default function RootLayout({
  ...
  return (
    <html lang="en-GB">
      ...
      <body className={`${archivoBlack.variable} ${barlow.variable}`}>{children}</body>
    </html>
  );
}

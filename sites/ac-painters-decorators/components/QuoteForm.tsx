    ...
    >
      {submitted ? (
        <div className="form-success" role="status">
          Thanks, your job details are ready to send to Chris.
        </div>
      ) : null}
      ...
      <div className={`form-row${invalid.jobtype ? " has-error" : ""}`}>
        ...
        <select id="jobtype" name="jobtype" required defaultValue=""
          ...
          <option value="feature">Feature colour</option>
          <option value="wallpaper">Wallpaper</option>
          <option value="furniture">Furniture and shelving</option>
      ...
      <div className={`form-row${invalid.details ? " has-error" : ""}`}>
        ...
        <textarea id="details" name="details" rows={4} required
          placeholder="The room or the outside, the colours you have in mind, and roughly when."

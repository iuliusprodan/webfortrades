...
import { Schibsted_Grotesk, Mulish } from "next/font/google";
...
const ogImages = meta.ogImage
  ? [{ url: meta.ogImage, width: 1200, height: 630, alt: `${brief.business_name}, Killingworth` }]
  : undefined;
...
function localBusinessJsonLd() {
  ...
  return {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: "Killingworth",
      addressRegion: "North Tyneside",
      postalCode: "NE12",
      addressCountry: "GB",
    },
    areaServed: [

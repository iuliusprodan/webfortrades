    ...
    >
      {submitted ? (
        <div className="form-success" role="status">
          Thanks, your job details are ready to send to Dan.
        </div>
      ) : null}
      ...
      <div className={`form-row${invalid.jobtype ? " has-error" : ""}`}>
        ...
        <select id="jobtype" name="jobtype" required defaultValue=""
          ...
          <option value="whole-home">Whole-home redecoration</option>
          <option value="few-rooms">A few rooms</option>
          <option value="doors-woodwork">Doors and woodwork</option>
      ...
      <div className={`form-row${invalid.details ? " has-error" : ""}`}>
        ...
        <textarea id="details" name="details" rows={4} required
          placeholder="The rooms, what you're after, and roughly when."

...
- Ran: 2026-06-10T19:51:44.484Z
- Facebook: https://www.facebook.com/GPPlumbingandHeatingLtd (verified=true)

## Comparison

| Source | Max width | Notes |
|--------|-----------|-------|
| Existing Facebook (before) | 320px | brief/images |
| Public HTML fallback | -px | 0 probed |
| Meta Graph API | -px | Meta Graph API: not configured (public HTML fallback only) |
| Apify | -px | Apify: not configured (set APIFY_TOKEN in .env for high-res Facebook fallback) |
...
Facebook still low-res. Prefer Google Places photos for gallery. Run Apify enrichment or manual asset export.
